import {
    ESortDirection, TExternalRoleListInput,
    TExternalServiceListInput,
    TSortInput,
    TUserListInput,
} from '../../../types/graphql/graphql.ts'

export const varsBehaviourMapExternalRoles = (initialVars: any): TExternalRoleListInput => {
    ...
    const mutatedVars: TExternalRoleListInput = {
